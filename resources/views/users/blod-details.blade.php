...
<div class="page-title dark-background">
    <div class="container position-relative">
        ...
        <nav class="breadcrumbs">
            <ol>
                <li><a href="/user-panel">Home</a></li>
                ...
                <div class="container">
                    ...
                    <article class="article">
                        ...
                        <div class="meta-top">
                            <ul>
                                <li class="d-flex align-items-center"><i class="bi bi-person"></i> <a
                                        href="/blog-details">John Doe</a></li>
                                <li class="d-flex align-items-center"><i class="bi bi-clock"></i> <a
                                        href="/blog-details"><time datetime="2020-01-01">Jan 1, 2022</time></a></li>
                                <li class="d-flex align-items-center"><i class="bi bi-chat-dots"></i> <a
                                        href="/blog-details">12 Comments</a></li>
                            </ul>
                        </div><!-- End meta top -->
                        ...
                        <div class="content">
                            ...
                            <img src="{{asset('users/assets/img/blog/blog-inside-post.jpg')}}" class="img-fluid" alt="">
            ...
            <section id="blog-comments" class="blog-comments section">
                ...
                <div class="container">
                    ...
                    <div id="comment-1" class="comment">
                        <div class="d-flex">
                            <div class="comment-img"><img src="{{asset('users/assets/img/blog/comments-1.jpg')}}" alt=""></div>
                            <div>
                    ...
                    <div id="comment-2" class="comment">
                        <div class="d-flex">
                            <div class="comment-img"><img src="{{asset('users/assets/img/blog/comments-2.jpg')}}" alt=""></div>
                            <div>
                        ...
                        <div id="comment-reply-1" class="comment comment-reply">
                            <div class="d-flex">
                                <div class="comment-img"><img src="{{asset('users/assets/img/blog/comments-3.jpg')}}" alt=""></div>
                                <div>
                            ...
                            <div id="comment-reply-2" class="comment comment-reply">
                                <div class="d-flex">
                                    <div class="comment-img"><img src="{{asset('users/assets/img/blog/comments-4.jpg')}}" alt=""></div>
                                    <div>
                    ...
                    <div id="comment-3" class="comment">
                        <div class="d-flex">
                            <div class="comment-img"><img src="{{asset('users/assets/img/blog/comments-5.jpg')}}" alt=""></div>
                            <div>
                    ...
                    <div id="comment-4" class="comment">
                        <div class="d-flex">
                            <div class="comment-img"><img src="{{asset('users/assets/img/blog/comments-6.jpg')}}" alt=""></div>
                            <div>
            ...
            <div class="widgets-container">
                ...
                <div class="blog-author-widget widget-item">
                    ...
                    <div class="d-flex flex-column align-items-center">
                        <img src="{{asset('users/assets/img/blog/blog-author.jpg')}}" class="rounded-circle flex-shrink-0" alt="">
                        <h4>Jane Smith</h4>
